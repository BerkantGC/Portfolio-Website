  ...
  return (
    <section id="projects" className="projects">
      ...
      <div className='projects-details'>
        <div href="https://github.com/BerkantGC/YasarForum" style={{backgroundImage: `url(${YaşarForumImage})`}}>
          <div>YAŞAR FORUM<p>I developed this project for Yaşar University students to share their ideas, class
            ...
            Spring Boot and MySQL.<br/><a target='_blank' href='https://github.com/BerkantGC/YasarForum'>Link</a></p>
          </div>
        </div>
        ...
        <div style={{backgroundImage: `url(${FileEncryptImage})`}}>
          <div>FILE ENCRYPTION AND SIGNING SOFTWARE<p>
            ...
            encryption(AES) and asymmetric encryption(RSA) were all used in project<br/><a target='_blank' href='https://github.com/BerkantGC/File-Encryption-Signing-Software'>Link</a></p>
            </div>
        </div>
        ...
        <div style={{backgroundImage: `url(${SportfriendImage})`}}>
          ...
          It's built using Spring for the backend, React.js for the frontend, and MySQL for the database.<br/><a target='_blank' href='https://github.com/BerkantGC/Sportfriend-App'>Link</a></p></div>
        </div>
        ...
        <div style={{backgroundImage: `url(${MugTreeImage})`}}>
          <div>MUG TREE
            ...
            used.<br/><a href='https://yumug.netlify.app/' target='_blank'>Link</a></p>
          </div>
        </div>
        ...
        <div style={{backgroundImage: `url(${MovieAppImage})`}}>
          ...
          information about movies.<br/><a target='_blank' href='https://github.com/BerkantGC/Movie-App'>Link</a></p></div>
        </div>
        ...
        <div style={{backgroundImage: `url(${FindMazeExitImage})`}}>
          ...
          breadth-first search (BFS).<br/><a target='_blank' href='https://github.com/BerkantGC/Find-Exit-of-Maze'>Link</a></p></div>
        </div>
      </div>
    </section>
  );
